#include <servo_control/servo_control_header.h>
...
void ROBOTHardwareInterface::write(ros::Duration elapsed_time) {
    ...
    joint_velocity_ = joint_velocity_ + dt*joint_effort_command_;
    joint_position_ = joint_position_ + dt*joint_velocity_;
...
*/	
	...
	ROS_INFO("Cmd: %.2f, Vel: %.2f, Pos:%.2f, Ang:%.2f",joint_effort_command_,joint_velocity_,joint_position_,angle);
