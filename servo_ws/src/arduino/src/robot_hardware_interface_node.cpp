#include <arduino/robot_hardware_interface.h>
...
ROBOTHardwareInterface::ROBOTHardwareInterface(ros::NodeHandle& nh) : nh_(nh) {
	...
	pub = nh_.advertise<std_msgs::Float32MultiArray>("/joints_to_arduino",10);
	client = nh_.serviceClient<arduino::Floats_array>("/read_joint_state");
